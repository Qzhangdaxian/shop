...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/tabBar/active-cart.png",
      text: "\u8D2D\u7269\u8F66"
    },
    {
      pagePath: "pages/personal-center/personal-center",
      iconPath: "static/tabBar/personal.png",
      selectedIconPath: "static/tabBar/active-personal.png",
      text: "\u6211\u7684"
    }
  ]
};
...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.2.139"\n    ],\n    "debugPort": 50859,\n    "initialLaunchType": "local",\n    "servePort": 50860,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"little-black-panther","spaceId":"9efcc4d4-4f72-434f-915f-6bf14fb4e790","clientSecret":"Pr2e7lqXhLx7o27Fh52xVw==","endpoint":"https://api.bspapp.com"}]');
let _ = "";
try {
  _ = "__UNI__9B9FA01";
} catch (e) {
